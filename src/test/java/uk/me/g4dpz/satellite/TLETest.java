...
public final class TLETest extends AbstractSatelliteTestBase {
    ...
    private void checkData(final TLE tle) {
        ...
        Assert.assertEquals("105.6639197", String.format(Locale.UK, FORMAT_11_7F, tle.getRefepoch()));
        Assert.assertEquals("98.0551000", String.format(Locale.UK, FORMAT_10_7F, tle.getIncl()));
        Assert.assertEquals("118.9086000", String.format(Locale.UK, FORMAT_11_7F, tle.getRaan()));
        Assert.assertEquals(VALUE_0_0084159, String.format(Locale.UK, FORMAT_9_7F, tle.getEccn()));
        Assert.assertEquals("315.8041000", String.format(Locale.UK, FORMAT_10_7F, tle.getArgper()));
        Assert.assertEquals(" 43.6444000", String.format(Locale.UK, FORMAT_11_7F, tle.getMeanan()));
        Assert.assertEquals("14.4063845", String.format(Locale.UK, FORMAT_10_7F, tle.getMeanmo()));
        Assert.assertEquals(VALUE_0_0000, String.format(Locale.UK, FORMAT_6_4F, tle.getDrag()));
        Assert.assertEquals(VALUE_0_0000, String.format(Locale.UK, FORMAT_6_4F, tle.getNddot6()));
        Assert.assertEquals("0.0000138", String.format(Locale.UK, FORMAT_9_7F, tle.getBstar()));
        Assert.assertEquals(25195, tle.getOrbitnum());
        Assert.assertEquals("9105.6639197", String.format(Locale.UK, "%12.7f", tle.getEpoch()));
        Assert.assertEquals("0.0000000", String.format(Locale.UK, FORMAT_9_7F, tle.getXndt2o()));
        Assert.assertEquals("1.7113843", String.format(Locale.UK, FORMAT_9_7F, tle.getXincl()));
        Assert.assertEquals("2.0753466", String.format(Locale.UK, FORMAT_9_7F, tle.getXnodeo()));
        Assert.assertEquals(VALUE_0_0084159, String.format(Locale.UK, FORMAT_9_7F, tle.getEo()));
        Assert.assertEquals("5.5118213", String.format(Locale.UK, FORMAT_9_7F, tle.getOmegao()));
        Assert.assertEquals("0.7617385", String.format(Locale.UK, FORMAT_9_7F, tle.getXmo()));
        Assert.assertEquals("0.062860", String.format(Locale.UK, "%8.6f", tle.getXno()));
